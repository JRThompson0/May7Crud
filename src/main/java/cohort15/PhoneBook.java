...
public class PhoneBook {
    public HashMap<String, ArrayList<String>> getPhoneRecord()
    {
        return phoneRecord;
    }
    public void setPhoneRecord(HashMap<String, ArrayList<String>> phoneRecord)
    {
        this.phoneRecord = phoneRecord;
    }

    private HashMap<String, ArrayList<String>> phoneRecord;

    public PhoneBook(){
        this(new HashMap<>());
    }

    public PhoneBook(HashMap<String, ArrayList<String>> phoneRecord) {
        this.phoneRecord = phoneRecord;
    }
    ...
    public void add(String name, String phoneNumber)
    {
        ...
        {
            ArrayList<String> workingList = phoneRecord.get(name);
                    ...
                    String... phoneNumbers)
    {
        ...
        if (!phoneRecord.containsKey(name)) {
            ArrayList<String> numbers = new ArrayList<>(List.of(phoneNumbers));
            phoneRecord.put(name, numbers);  //put the record in the map
        }
        else
        {
    ...
    public String reverseLookUp(String phoneNumber)
    {
        ...
        Iterator<Map.Entry<String, ArrayList<String>>> iteratito = phoneRecord.entrySet().iterator();
        //iterate through the phonebook to go through all the numbers in each entry.
        while(iteratito.hasNext())
        {
            Map.Entry<String, ArrayList<String>> currentEntry = iteratito.next();
    ...
    public ArrayList<String> getAllContactNames()
    {
        ...
        return (ArrayList<String>) phoneRecord.keySet().stream().toList();
    }
